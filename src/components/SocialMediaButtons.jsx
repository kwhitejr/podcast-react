  ...
  render() {
    ...
    return <div>
      <ul className="share-menu">
        <li className="share-menu-item"><RedditButton url={url}/></li>
        <li className="share-menu-item"><PinterestButton url={url}/></li>
        <li className="share-menu-item"><GooglePlusButton url={url}/></li>
        <li className="share-menu-item"><FacebookButton url={url}/></li>
        <li className="share-menu-item"><TwitterButton url={url}/></li>
      </ul>
    </div>
  }
});
